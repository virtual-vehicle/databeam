    ...
    def command_apply_config(self) -> Status:
        ...
        try:
            ...
            if self._server is None:
                self._websocket_api = WebSocketAPI(ip="0.0.0.0", port=6011)
                ...
                self._server = Server(self.module_interface.cm, self.module_interface.db_id, self._shutdown_queue,
                                      self.module_interface.live_data_receiver, self.config_handler,
                                      self._websocket_api)
